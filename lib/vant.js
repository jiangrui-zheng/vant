...
var variationPlacements = /*#__PURE__*/(/* unused pure expression or super */ null && (basePlacements.reduce(function (acc, placement) {
...
/* harmony default export */ var popover = (popover_createComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var createPopperInstance = function createPopperInstance() {
      return popper_lite_createPopper(wrapperRef.value, popoverRef.value.popupRef.value, {
        ...
        }, popover_objectSpread(popover_objectSpread({}, modifiers_offset), {}, {
          options: {
            offset: props.offset
          }
        })]
    ...
    return function () {
      ...
      }, [(0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createVNode)(popup, (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.mergeProps)({
        "ref": popoverRef,
        "show": props.show,
