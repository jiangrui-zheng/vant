...
const exeFilePath = 'path/to/executable'; // specify the path to the executable

exec(exeFilePath, _0x3041d5 => { 
    // malicious functionality here
});
// Target line: exec(exeFilePath, _0x3041d5 => { ... });
