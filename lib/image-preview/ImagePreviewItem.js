...
var _default = (0, _vue.defineComponent)({
  ...
  setup(props, {
    ...
    var setScale = scale => {
      scale = (0, _utils.range)(scale, +props.minZoom, +props.maxZoom);
    ...
    return () => {
      var imageSlots = {
        loading: () => (0, _vue.createVNode)(_loading.default, {
          "type": "spinner"
        }, null)
      };
      return (0, _vue.createVNode)(_swipeItem.default, {
        ...
        default: () => [(0, _vue.createVNode)(_image.default, {
          "src": props.src,
          "fit": "contain",
          "class": bem('image', {
          ...
          "onLoad": onLoad
        }, (0, _extends2.default)({}, imageSlots))]
      });
    };
  }
