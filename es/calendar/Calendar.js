...
import { t, bem, name, copyDate, copyDates, getPrevDay, getNextDay, compareDay, calcDateNum, compareMonth, getDayByOffset } from './utils'; // Composables
...
export default defineComponent({
  ...
  setup(props, {
    ...
    var onConfirm = () => emit('confirm', copyDates(state.currentDate));
