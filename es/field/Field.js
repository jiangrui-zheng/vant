...
import { isDef, addUnit, UnknownProp, resetScroll, formatNumber, preventDefault, createNamespace } from '../utils';
...
var [name, bem] = createNamespace('field');
export default defineComponent({
  ...
  setup(props, {
    ...
    var renderInput = () => {
      ...
      return _createVNode("input", _extends({}, mapInputType(props.type), inputAttrs), null);
    };
