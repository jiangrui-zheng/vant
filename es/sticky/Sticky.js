...
import { ref, computed, reactive, defineComponent } from 'vue'; // Utils

import { isHidden, unitToPx, getScrollTop, getZIndexStyle, createNamespace } from '../utils'; // Composables
...
export default defineComponent({
  ...
  setup(props, {
    ...
    var stickyStyle = computed(() => {
      ...
      var style = _extends({}, getZIndexStyle(props.zIndex), {
