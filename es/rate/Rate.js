...
import { addUnit, createNamespace, preventDefault } from '../utils'; // Composables
...
export default defineComponent({
  ...
  setup(props, {
    ...
    var list = computed(() => Array(props.count).fill('').map((_, i) => getRateStatus(props.modelValue, i + 1, props.allowHalf)));
